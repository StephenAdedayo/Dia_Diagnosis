  ...
  return (
    <div className='px-5 lg:px-40 w-full py-20'>
         ...
         <div className='space-y-5 flex-[60%]'>
          ...
          <p className='text-[#547593] text-[17px] md:w-[500px] w-full'>Letraset sheets containing Lorem Ipsum passages and more recently with desktop publishing Various versions have evolved over the years, sometimes.</p>
         </div>
         ...
         <div className='space-y-5'>
          ...
          <div className='mt-20 flex flex-col gap-8 md:flex-row justify-between'>
              ...
              <div className='flex flex-col md:flex-row md:gap-14 gap-2 md:items-center'>
                ...
                <div className='flex'>
                  <input type="email" placeholder='email address' className='outline-none border border-[#D5E4F1] flex-1 px-2 py-3' required/>
                  <button className='px-6 py-3 bg-[#2F73F2] text-white'>Subscribe</button>
                </div>
              </div>
          </div>
