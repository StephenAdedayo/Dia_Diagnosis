      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <div className="absolute top-4 flex justify-between w-full px-5">
            <img src="" alt="" />
            <button onClick={() => navigate('/signup')} className="border uppercase text-[13px] bg-transparent px-5 py-2">
              Sign Up
            </button>
          </div>
        </div>
        ...
        <form action="" className="bg-white shadow p-10 absolute w-full max-w-[500px] inner ">
          <div>
            <h1 className="text-center text-[#212121] font-bold leading-[35px]">Login For Quick Diagnosis</h1>
...
<input type="checkbox" className="w-[15px]" id="Remember Me"/>
            <label htmlFor="Remember Me" className="text-[10px] text-[#616161]">Remember Me</label> 
            </div>
       ...
       <Link>
        <p className="text-[10px] text-[#616161]">Forgot Password?</p>
          ...
          <button className="bg-black text-white uppercase text-center w-full py-3">proceed</button>
          </div>
