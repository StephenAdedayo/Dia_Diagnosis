...
import vector1 from './Vector (3).png'
import vector2 from './Vector (4).png'
...
export const assets = {
    ...
    button, folderNotch, logo, icon1, icon2, icon3, vector1, vector2, Notebook, shopping, vector3, upload_area, button2
